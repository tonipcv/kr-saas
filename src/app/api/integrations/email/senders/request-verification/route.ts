...
export async function POST(req: NextRequest) {
  try {
    ...
    const FROM_NAME = process.env.EMAIL_FROM_NAME || 'Zuzz';
    ...
    const html = `<!doctype html><html><head><meta charset="utf-8"/></head><body>
      <div style="max-width:560px;margin:0 auto;border:1px solid #e5e7eb;border-radius:12px;overflow:hidden">
        <div style="background:#111827;color:#fff;padding:14px 18px;font-family:Arial,Helvetica,sans-serif;font-size:16px;font-weight:600">Zuzz</div>
        <div style="padding:18px 18px 8px 18px;font-family:Arial,Helvetica,sans-serif;color:#111827">
          ...
          <p style="margin:0 0 0 0;">— Equipe Zuzz</p>
        </div>
      </div>
    </body></html>`;
