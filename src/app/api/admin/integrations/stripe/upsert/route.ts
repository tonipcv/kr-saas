...
// Admin endpoint to save/update Stripe credentials per merchant.
// Non-invasive: does not change any legacy flow; only persists to merchant_integrations.
// Protect with your existing auth/middleware if needed.
