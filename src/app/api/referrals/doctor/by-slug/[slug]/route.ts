  ...
  try {
    ...
    if (!doctor) {
      ...
      return NextResponse.json(
        {
          error: 'Médico não encontrado para o slug informado.',
          requested_slug: slug,
          suggestions,
          hint:
            'Verifique se o médico possui um Public Slug salvo em /doctor/profile e use exatamente o valor exibido. O match é case-insensitive.',
        },
        { status: 404 }
      );
    }
