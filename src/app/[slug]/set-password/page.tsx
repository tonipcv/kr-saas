...
function SetPasswordForm() {
  ...
  useEffect(() => {
    if (token) {
      ...
      setError('Invalid set-password link');
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setSuccess(true);
        setTimeout(() => {
          router.push(`/${slug}/login?set=1&email=${encodeURIComponent(emailToUse)}`);
        }, 3000);
      } else {
        const error = await response.json();
        setError(error.error || 'Error setting password');
      }
    } catch (error) {
        ...
        <div className="min-h-screen flex flex-col items-center justify-center p-4">
          <div className="w-full max-w-[420px] bg-white rounded-2xl border border-gray-200 p-8 shadow-lg relative z-20">
            <div className="text-center">
              ...
              <h2 className="text-xl font-medium text-gray-900 mb-2">Invalid Link</h2>
              ...
              <div className="mt-6 pt-4 border-t border-gray-200">
                <div className="flex items-center justify-center gap-2">
                  ...
                  <Image src="/logo.png" alt="Sistema" width={32} height={10} className="object-contain opacity-60" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="min-h-screen flex flex-col items-center justify-center p-4">
          <div className="w-full max-w-[420px] bg-white rounded-2xl border border-gray-200 p-8 shadow-lg relative z-20">
            <div className="text-center">
              ...
              <h2 className="text-xl font-medium text-gray-900 mb-2">Password Set!</h2>
              <p className="text-gray-600 mb-6">Your password has been created successfully.</p>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white font-normal tracking-[-0.03em] relative z-10">
      ...
      <div className="min-h-screen flex flex-col items-center justify-center p-4">
        <div className="w-full max-w-[420px] bg-white rounded-2xl border border-gray-200 p-8 shadow-lg relative z-20">
          <div className="text-center mb-6">
            <h1 className="text-xl font-medium text-gray-900 mb-2">Create Your Password</h1>
            <p className="text-gray-600 text-sm">Welcome! Please create your password to access your account.</p>
            {userEmail && (
