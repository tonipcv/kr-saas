              ...
              <Card className="bg-white border-gray-200 shadow-sm rounded-2xl">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div>
                    ...
                    <Input id="subtitle" value={formData.subtitle} onChange={(e) => handleInputChange('subtitle', e.target.value)} placeholder="Breve subtítulo do produto" className="mt-2 border-gray-300 focus:border-[#5154e7] focus:ring-[#5154e7] bg-white text-gray-700 placeholder:text-gray-500 rounded-xl h-10" />
                  </div>
                  ...
                  <div>
                    <div className="flex items-center justify-between">
                      ...
                      <button type="button" className="text-xs text-[#5154e7] hover:underline" onClick={() => setWaModalOpen(true)}>Gerar link de WhatsApp</button>
                    </div>
                    <Input id="confirmationUrl" value={formData.confirmationUrl || ''} onChange={(e) => handleInputChange('confirmationUrl', e.target.value)} placeholder="Ex.: /thank-you ou https://seusite.com/obrigado" className="mt-2 border-gray-300 focus:border-[#5154e7] focus:ring-[#5154e7] bg-white text-gray-700 placeholder:text-gray-500 rounded-xl h-10" />
                ...
                <CardContent className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <Input id="originalPrice" value={formData.originalPrice} onChange={(e) => handleInputChange('originalPrice', e.target.value)} placeholder="0.00" type="number" step="0.01" min="0" className="mt-2 border-gray-300 focus:border-[#5154e7] focus:ring-[#5154e7] bg-white text-gray-700 placeholder:text-gray-500 rounded-xl h-10" />
                    </div>
                    <div>
                      <Label htmlFor="discountPrice" className="text-gray-900 font-medium">Discount Price</Label>
                      <Input id="discountPrice" value={formData.discountPrice} onChange={(e) => handleInputChange('discountPrice', e.target.value)} placeholder="0.00" type="number" step="0.01" min="0" className="mt-2 border-gray-300 focus:border-[#5154e7] focus:ring-[#5154e7] bg-white text-gray-700 placeholder:text-gray-500 rounded-xl h-10" />
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white border-gray-200 shadow-sm rounded-2xl">
                ...
                <CardContent>
                  <div>
                    ...
                    <Input id="creditsPerUnit" value={formData.creditsPerUnit} onChange={(e) => handleInputChange('creditsPerUnit', e.target.value)} placeholder="0" type="number" min="0" className="mt-2 border-gray-300 focus:border-[#5154e7] focus:ring-[#5154e7] bg-white text-gray-700 placeholder:text-gray-500 rounded-xl h-10" />
                  </div>
                  <div className="mt-6">
                    <Label htmlFor="priority" className="text-gray-900 font-medium">Priority (higher shows first)</Label>
                    <Input id="priority" value={formData.priority} onChange={(e) => handleInputChange('priority', e.target.value)} placeholder="0" type="number" className="mt-2 border-gray-300 focus:border-[#5154e7] focus:ring-[#5154e7] bg-white text-gray-700 placeholder:text-gray-500 rounded-xl h-10" />
              ...
              <Card className="bg-white border-gray-200 shadow-sm rounded-2xl">
                ...
                <CardContent className="space-y-6">
                  <div>
                    ...
                    <Input id="purchaseUrl" value={formData.purchaseUrl} onChange={(e) => handleInputChange('purchaseUrl', e.target.value)} placeholder="https://store.com/product" type="url" className="mt-2 border-gray-300 focus:border-[#5154e7] focus:ring-[#5154e7] bg-white text-gray-700 placeholder:text-gray-500 rounded-xl h-10" />
                  </div>
                  <div>
                    <Label htmlFor="usageStats" className="text-gray-900 font-medium">Usage Statistics (%)</Label>
                    <Input id="usageStats" value={formData.usageStats} onChange={(e) => handleInputChange('usageStats', e.target.value)} placeholder="0" type="number" min="0" max="100" className="mt-2 border-gray-300 focus:border-[#5154e7] focus:ring-[#5154e7] bg-white text-gray-700 placeholder:text-gray-500 rounded-xl h-10" />
                    <p className="text-sm text-gray-500 font-medium mt-2">Percentage of clients who use this product</p>
                  </div>
                </CardContent>
              </Card>
          ...
          <div className="relative z-10 w-full max-w-md mx-auto bg-white rounded-2xl shadow-xl border border-gray-200 p-5">
            ...
            <div className="mt-4 space-y-3">
              <div>
                ...
                <Input value={waNumber} onChange={(e) => setWaNumber(e.target.value)} placeholder="Ex.: 5591999999999" className="mt-1 border-gray-300 focus:border-[#5154e7] focus:ring-[#5154e7] bg-white text-gray-700 placeholder:text-gray-500 rounded-xl h-10" />
              </div>
              <div>
                <Label className="text-gray-900 font-medium">Mensagem</Label>
                <Textarea value={waText} onChange={(e) => setWaText(e.target.value)} rows={3} className="mt-1 border-gray-300 focus:border-[#5154e7] focus:ring-[#5154e7] bg-white text-gray-700 placeholder:text-gray-500 rounded-xl" />
                <p className="text-xs text-gray-500 mt-1">Use {'{{nome do produto}}'} para inserir automaticamente o nome do produto.</p>
              </div>
              <div className="text-xs text-gray-500">Pré-visualização: <a className="text-[#5154e7] underline break-all" target="_blank" href={getWhatsAppLink()}>{getWhatsAppLink() || '—'}</a></div>
              <div className="flex gap-2 pt-2">
                <Button type="button" className="bg-[#5154e7] hover:bg-[#4145d1] text-white rounded-xl h-10 flex-1" onClick={() => { const link = getWhatsAppLink(); if (!link) { alert('Informe um número válido.'); return; } handleInputChange('confirmationUrl', link); setWaModalOpen(false); }}>Usar este link</Button>
