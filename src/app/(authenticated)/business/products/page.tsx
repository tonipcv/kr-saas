          ...
          <div className="p-4 pt-[88px] lg:pl-6 lg:pr-4 lg:pt-6 lg:pb-4 pb-24 flex items-center justify-center min-h-[calc(100vh-88px)]">
            <Card className="w-full max-w-md bg-white border-gray-200 shadow-lg rounded-2xl">
              <CardHeader className="text-center p-6">
                ...
                <p className="text-gray-600 font-medium mt-2">Please select a clinic from the sidebar to view products.</p>
              </CardHeader>
            </Card>
          </div>
        </div>
        ...
        <div className="p-4 pt-[88px] lg:pl-6 lg:pr-4 lg:pt-6 lg:pb-4 pb-24">
          ...
          {isFree ? (
            <div className="relative">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center px-4">
                  ...
                  <div className="mt-3">
                    <Button size="sm" className="h-8 bg-gray-900 text-white hover:bg-black rounded-lg focus:ring-gray-900">See plans</Button>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="text-center py-12">
              ...
              <h3 className="mt-2 text-sm font-semibold text-gray-900">No products registered</h3>
              <p className="mt-1 text-sm text-gray-500">Start by creating your first product to recommend to clients.</p>
              <div className="mt-6">
                <Button asChild className="bg-gray-900 hover:bg-black text-white shadow-sm rounded-xl font-medium">
            ...
            <>
              <div className="mb-3 flex flex-col sm:flex-row sm:items-center gap-3">
                ...
                <div className="flex items-center gap-2">
                  <Button variant="outline" size="sm" className="h-8 text-gray-700 hover:bg-gray-50">Filters</Button>
                  <Button variant="outline" size="sm" className="h-8 text-gray-700 hover:bg-gray-50">Sort</Button>
                </div>
              </div>
          ...
          {filteredProducts.length > 0 && (
            <div className="mt-4 flex items-center justify-between">
              <p className="text-sm text-gray-600">Showing {startIndex + 1}-{Math.min(endIndex, totalProducts)} of {totalProducts}</p>
              <div className="flex items-center gap-2">
                <Button variant="outline" size="sm" className="h-8 text-gray-700 hover:bg-gray-50" onClick={() => setCurrentPage(p => Math.max(1, p - 1))} disabled={currentPage === 1}>
                  <ChevronLeftIcon className="h-3.5 w-3.5" />
                </Button>
                <span className="text-sm text-gray-700">Page {currentPage} of {totalPages}</span>
                <Button variant="outline" size="sm" className="h-8 text-gray-700 hover:bg-gray-50" onClick={() => setCurrentPage(p => Math.min(totalPages, p + 1))} disabled={currentPage === totalPages}>
          ...
          <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
            <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto bg-white border border-gray-200 rounded-2xl">
              <DialogHeader>
                <DialogTitle className="text-[18px] font-semibold text-gray-900 tracking-[-0.01em]">Product details</DialogTitle>
              </DialogHeader>
